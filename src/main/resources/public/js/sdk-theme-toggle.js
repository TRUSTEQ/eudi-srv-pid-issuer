 ...
 * localStorage (local to this subsite, a pure display preference with no
 * reason to ever reach the server - same key scheme as the client site's
 * own 'client-site-theme', just named for this app instead).
 *
 ...
 * (see sdk-theme-restore.js for the other half of that same reasoning).
 *
...
(function () {
  ...
  var STORAGE_KEY = "sdk-issuer-theme";
  var SUN_ICON =
  ...
  function syncIcon() {
    var btn = document.getElementById("sdk-theme-toggle");
